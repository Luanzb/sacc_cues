...
eyedf = edfmex(fullfile([data_folder 'Subject1/eyetracking/Sacc_sub1_ses3_20220511-1216.edf']));
...
prehits = Response(:,1) == matrix(:,3); % recebe 1 se a pessoa acertou a discriminação
lat_sac = s.macrosacvec(:,1)/1000; % latencia das sacadas transformada para ms

median = mean(nonzeros(lat_sac))
